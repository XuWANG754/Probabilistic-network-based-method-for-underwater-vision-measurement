...
from Net_MPMC_Test import mynet
from data import get_eval_set

if __name__ == "__main__":
# settings
    parser = argparse.ArgumentParser(description='PyTorch Net_MCMP')
    parser.add_argument('--testBatchSize', type=int, default=1, help='testing batch size')
    parser.add_argument('--gpu_mode', type=bool, default=True)
    parser.add_argument('--threads', type=int, default=4, help='number of threads for data loader to use')
    parser.add_argument('--seed', type=int, default=123, help='random seed to use Default=123')
    parser.add_argument('--device', type=str, default='cuda:0')
    parser.add_argument('--input_dir', type=str, default='path of input')
    parser.add_argument('--output', default='results', help='Location to save checkpoint models')
    parser.add_argument('--reference_out', type=str, default='mp')
    parser.add_argument('--model', default='weights', help='Pretrained base model')
